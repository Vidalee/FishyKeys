...
//
// key_management client HTTP transport
//
// Command:
...
// Client lists the key_management service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the key_management service
// servers.
func NewClient(
	scheme string,
	host string,
...
// key_management service create_master_key server.
func (c *Client) CreateMasterKey() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("key_management", "create_master_key", err)
		}
		return decodeResponse(resp)
	}
}

// GetKeyStatus returns an endpoint that makes HTTP requests to the
// key_management service get_key_status server.
func (c *Client) GetKeyStatus() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("key_management", "get_key_status", err)
		}
		return decodeResponse(resp)
	}
}

// AddShare returns an endpoint that makes HTTP requests to the key_management
...
func (c *Client) AddShare() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("key_management", "add_share", err)
		}
		return decodeResponse(resp)
	}
}

// DeleteShare returns an endpoint that makes HTTP requests to the
// key_management service delete_share server.
func (c *Client) DeleteShare() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("key_management", "delete_share", err)
		}
		return decodeResponse(resp)
	}
}
