...
// NewGetOperatorTokenResultOK builds a "users" service "get operator token"
// endpoint result from a HTTP "OK" response.
func NewGetOperatorTokenResultOK(body *GetOperatorTokenResponseBody) *users.GetOperatorTokenResult {
	v := &users.GetOperatorTokenResult{
		Username: body.Username,
		Token:    body.Token,
	}
...
// NewGetOperatorTokenInternalError builds a users service get operator token
// endpoint internal_error error.
func NewGetOperatorTokenInternalError(body *GetOperatorTokenInternalErrorResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
		Message:   *body.Message,
...
// ValidateGetOperatorTokenInternalErrorResponseBody runs the validations
// defined on get operator token_internal_error_response_body
func ValidateGetOperatorTokenInternalErrorResponseBody(body *GetOperatorTokenInternalErrorResponseBody) (err error) {
	if body.Name == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("name", "body"))
	}
	if body.ID == nil {
